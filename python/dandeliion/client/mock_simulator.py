...
# custom modules
from .simulator import Solution, Simulator
from .tools.misc import update_dict

root_path = Path(__file__).parent.parent.parent.parent
with open(root_path / 'tests' / 'python' / 'dandeliion' / 'client' / 'data' / 'output_server_submit.json', 'r') as f:
    submit_data = json.load(f)

with open(root_path / 'tests' / 'python' / 'dandeliion' / 'client' / 'data' / 'output_server_finished.json', 'r') as f:
